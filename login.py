...
if __name__ == '__main__':
    ...
    remember_me = ctk.CTkCheckBox(login, text="Remember Me", font=("Arial", 15),
                                  checkmark_color="white", fg_color="#FF8433", hover_color="#FF6500")
    remember_me.place(x=100, y=335)

    # CREATES AND PLACES THE LOGIN BUTTON
    login_button = ctk.CTkButton(login, text="Login",
                                 font=("Arial", 20), fg_color="#FF8433", hover_color="#FF6500",
    ...
    register_button = ctk.CTkButton(login, text="Register",
                                    font=("Arial", 20), fg_color="#FF8433", hover_color="#FF6500", command=register)
